...
class BirdDataset(Dataset):
    ...
    def read_file(self, sample_info):
        ...
        # get random offset
        _, audio_duration = self.get_audio_offset(filepath, duration=self.duration)
        if self.is_train == True:
            offset=int(sample_info['offset'])
    ...
    def __getitem__(self, idx):
        ...
        features, audio_duration = self.read_file(sample_info)
