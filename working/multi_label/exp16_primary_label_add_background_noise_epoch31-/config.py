...
class CFG:
    ...
    exp_name = 'baseline'
    comment = 'EfficientNetB1|224x313|t=8s|lr=1e-3|act=sigmoid|fine-tuning|RandomCrop|add_background_noise|epoch31-'
    ...
    BACKNOISE_BASE_PATH = '/kaggle/input/birdclef-2023-dataset/birdclef2021-background-noise'
    # Verbosity level
    verbose = 0
    ...
    pretrain = True
    pretrained_model_path = '/kaggle/working/multi_label/exp15_primary_label_add_background_noise/fold-0.pth'
