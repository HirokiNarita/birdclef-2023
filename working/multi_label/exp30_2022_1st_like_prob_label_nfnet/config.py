...
class CFG:
    ...
    exp_name = 'baseline'
    comment = 'exp30|eca_nfnet_l0|add union(20,21,22,xeno)|loss=bce|fine-tuning(timm)|2022_1st_like|2022_3rd_like_label'
    ...
    start_fold = 0
    start_epoch = 33
    start_weight_path = '/kaggle/working/multi_label/exp30_2022_1st_like_prob_label_nfnet/fold-0.pth'
    continue_lr = 0.000443
