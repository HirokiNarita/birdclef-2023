...
class CFG:
    ...
    exp_name = 'baseline'
    comment = 'EfficientNetB1|224x313|t=8s|lr=1e-4|act=sigmoid|att_block|RandomHorizontalFlop|Finetuning'
    ...
    pretrain = True
    pretrained_model_path = '/kaggle/working/pre-training/fold-0_20230501_pretrained.pth'
