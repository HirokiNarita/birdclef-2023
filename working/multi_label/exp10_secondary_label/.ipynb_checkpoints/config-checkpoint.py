...
class CFG:
    ...
    exp_name = 'baseline'
    comment = 'EfficientNetB1|224x313|t=8s|lr=1e-3|act=sigmoid|secondary_label|'
    ...
    pretrain = True
    pretrained_model_path = '/kaggle/working/pre-training/exp1_pre_attblock_fold-0_20230501_pretrained.pth'
    ...
    sample_rate = 32000
    if is_test == True:
        audio_len = test_duration*sample_rate
    else:
