...
class CFG:
    ...
    exp_name = 'baseline'
    comment = 'EfficientNetB1|224x313|t=8s|lr=1e-3|act=sigmoid|secondary_label|epoch31-'
    ...
    pretrain = True
    pretrained_model_path = '/kaggle/working/multi_label/exp10_secondary_label/20230504_ver1_fold-0.pth'
