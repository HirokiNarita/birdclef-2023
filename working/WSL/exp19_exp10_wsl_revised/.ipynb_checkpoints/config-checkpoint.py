...
class CFG:
    ...
    exp_name = 'softmax_finetuning'
    comment = 'Finetuning|EfficientNetB1|224x313|t=8s|lr=cos|act=softmax|add_gaussian|prob_aug|wsl=raw|revised'
    ...
    pretrain = True
    pretrained_model_path = '/kaggle/working/pre-training/exp2_pre_softmax_horizontalflip/fold-0_20230503_21epoch.pth'
    inference_model_path = '/kaggle/input/birdclef-2023-baseline/fold-0.pth'
    #final_act = 'softmax'
    ...
    scheduler = 'cos'
    optimizer = 'AdamW'#, RectifiedAdam, Adam
